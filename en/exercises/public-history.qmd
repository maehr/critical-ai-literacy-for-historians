...
description: 'Exercise set for target audience-oriented communication of a scholarly article in multiple formats (blog, podcast, social media, poster, interview) – with AI protocol, source veto, and methodological transparency.'
author:
  - name: 'Moritz Mähr'
...
This exercise trains public history knowledge communication as **processual translation work**: from a scholarly article (argument, evidence, uncertainties) to audience-oriented formats. Generative AI is used here **not** as an authority, but as a _tool for drafting, variation, editing, and proofreading_ – with consistent source reference, traceability, and clear limits.
...
- Systematically verify responses (claim by claim, source veto, mark uncertainties) and document changes traceably in an AI protocol.
...
3. **Blog post** (approx. 700–1,000 words) _or_ **podcast script** (approx. 6–8 minutes)
...
- **AI protocol (audit trail):** Documentation of prompts, responses, decisions, corrections, and source references, so that your working process remains traceable.
- **Source veto:** An AI statement or narrative sharpening is rejected if it contradicts the statements documented in the article or is not supported by the material.
- **Claim-by-claim check:** Statements are decomposed into verifiable _claims_, linked to evidence, or marked as speculation.
...
Operationalize communication as a **context-dependent decision**: For _whom_, _where_, _why_, _in which medium_?
...
- Success criteria: What should recipients _know_ / _be able to do_ / _see differently_ afterward?
...
- Which simplifications would be epistemically risky? Note _red lines_.
...
1. **One-liner** (1 sentence): What is the core message – and why does it matter _for this target audience_?
...
- **Check claim by claim**: Every statement either supported, marked as framing, or deleted.
...
**Goal:** Translate core message into an _attention medium_ without overclaiming.
...
- **No-go list**: Statements you _won't_ make (due to evidence/complexity/ethics)
