...
2) **Critique:** Use the critical comparison from the *Research Question* exercise ("Why is X missing?" / "What sources does this rely on?").\
...
- @sternfeld2023historian – Explains how a machine learning system "learns" from a dataset, and why AI works as a socio-technical system rather than an autonomous agent.
