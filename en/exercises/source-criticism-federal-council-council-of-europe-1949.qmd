...
- @stark2023conjectural – Situates AI in the tradition of "conjectural sciences"; discusses epistemological risks of automated pattern recognition.
- @lang2026beyond – Ethical data work in the (digital) humanities; relevant to data provenance and dataset documentation.

::: callout-tip

## Optional Activity: Open Public Peer Review

Read and comment on @lang2026beyond via the open peer review process (Hypothes.is) on the [ZfdG page](https://zfdg.de/wp_2026). Reflect on how public peer review promotes transparency and uncertainty management in scholarship.
