...
Skizzieren Sie in 10 Minuten ein Arbeitsmodell des _Entscheidungsprozesses_ (Akteure, Arenen, Phasen, Dokumenttypen).
...
Für jede Zelle: _Was wäre ein überzeugender Beleg?_ / _Welche Verzerrungen sind wahrscheinlich?_
...
1. **Akteur**: Vorort; Schweizerischer Handels- und Industrie-Verein; SHIV; (FR) Union suisse du commerce et de l’industrie; economiesuisse (_rückprojizierend kennzeichnen_)
...
Arbeiten Sie im Zweifel mit einem kurzen Auszug oder mit einem [lokalen Modell](../glossary.qmd#gl-lokales-modell). Bei einem lokalen Modell bleibt das Material auf Ihrem Rechner.
:::
