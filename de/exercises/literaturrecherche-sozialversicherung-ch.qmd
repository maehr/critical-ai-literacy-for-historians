...
## Eigene Dokumente statt Weltwissen

Manche Konten erlauben den [Abruf aus eigenen Dokumenten](../glossary.qmd#gl-eigene-dokumente). Sie hinterlegen dabei Ihre PDF-Dateien, und ein Suchschritt wählt daraus die passenden Abschnitte aus [@lewis2020retrieval]. Für die Literaturanalyse in Schritt 6 ist das nützlich, denn die Antwort bleibt an Ihr Material gebunden.

Zwei Einschränkungen bleiben. Der Suchschritt findet nicht jeden relevanten Abschnitt, und das System antwortet trotzdem. Eine Stellenangabe belegt zudem nur die Fundstelle und nicht die Aussage. Öffnen Sie die genannte Seite und lesen Sie sie selbst.
