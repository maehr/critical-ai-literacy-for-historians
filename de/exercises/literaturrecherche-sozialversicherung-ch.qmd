...
- Grundkenntnisse in historischer Forschungsmethoden
- Zugang zu wissenschaftlichen Katalogen/Datenbanken (z. B. swisscovery)
- Grundkenntnisse in der Nutzung generativer KI
...
## Hinweis zur Materialität

Nicht alles ist digital zugänglich. Planen Sie Zugänge (Bibliothek, Fernleihe, Archiv) und beachten Sie, dass Plattformen/Kataloge Sichtbarkeit strukturieren (Erschliessungslogik) und keine Vollständigkeit garantieren.
:::
...
9. Reproduzierbarkeit und Nachweis (Pflicht)
...
- **KI-Protokoll (Anhang)**: 2–4 Prompts, gekürzte Outputs, Ihre Korrekturen/Rejects, Verwendungszweck
