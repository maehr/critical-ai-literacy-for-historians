...
| **Niveau**               | Intermediate                                                                                                                          |
| **Kernpfad**             | 1 → 2 → 3 → 5 → 6                                                                                                                     |
| **Optionale Vertiefung** | 4 (Kontextualisierung und Gegenprobe)                                                                                                 |
| **Abgabe (Minimum)**     | [Analyseprotokoll](../glossary.qmd#gl-analyseprotokoll) zu einer Quelle. [KI-Protokoll](../glossary.qmd#gl-ki-protokoll): 6 Einträge. |

Der Kernpfad führt Sie in ca. 180 Minuten zu einer vollständigen Quellenkritik. Schritt 4 kostet ca. 90 Minuten zusätzlich, denn Sie suchen dafür weitere Quellen.

Die zwei Protokolle haben unterschiedliche Aufgaben. Das Analyseprotokoll beschreibt die Quelle. Das KI-Protokoll beschreibt Ihre KI-Nutzung. Führen Sie beide getrennt.
...
- Eine hochgeladene Datei lesen und aus dieser Datei zitieren. Sie brauchen das ab Schritt 1.
- Eine Antwort in einem Format liefern, das Sie vorgeben, zum Beispiel als Tabelle mit Behauptung und Belegstelle.
- Im Web suchen und die Fundstellen mit einer Adresse belegen. Sie brauchen das nur in Schritt 4.

**Weitere Werkzeuge und Zugänge**

- Die Quelle als Datei. Sie laden das Dokument Dodis 5020 frei herunter, und Sie brauchen dafür keinen institutionellen Zugang.
- Eine Datei für Ihr Analyseprotokoll und eine Datei für Ihr KI-Protokoll.
...
### Aufgabe 1a: Minimalparaphrase ohne KI
...
### Aufgabe 1b: Dieselbe Minimalparaphrase mittels KI
...
Prüfen Sie vor dem Upload, ob Sie über das Material verfügen dürfen. Der Abschnitt «Was Sie brauchen» nennt die Materialien, die ausserhalb des KI-Systems bleiben. Freier Zugang allein erlaubt keinen Upload: eine frei zugängliche Quelle kann eine Weitergabe trotzdem untersagen. Prüfen Sie deshalb die Nutzungsbedingungen von Dodis, bevor Sie das Digitalisat hochladen.
...
## Ein KI-System kann eine Vorlage falsch lesen

Diese Übung nutzt eine edierte Fassung mit geprüftem Text. Bei einem Scan oder bei einer handschriftlichen Vorlage ist die Lage anders. Das System liest dann ein Bild und erzeugt daraus Text.

Ein allgemeines KI-System hält an einer unleserlichen Stelle nicht an. Es setzt ein plausibles Wort ein und markiert nichts. Die Fehlerrate der [Handschriftenerkennung](../glossary.qmd#gl-htr) hängt stark von Schrift, Layout und Sprache ab [@romein2025assessing; @diezgarcia2025evaluating]. Solche Fehler verändern jede spätere Auswertung [@vanstrien2020assessing].

Vergleichen Sie deshalb jedes Zitat mit dem Digitalisat. Notieren Sie im [Analyseprotokoll](../glossary.qmd#gl-analyseprotokoll), ob der Text maschinell erkannt wurde. Der Abschnitt [Fähigkeiten prüfen und einordnen](prompt-engineering.qmd#sec-faehigkeiten) erklärt diesen Punkt ausführlich.
:::
...
### Aufgabe 2a: Erste Forschungsheuristik ohne KI

Notieren Sie drei **potenzielle Forschungsfragen**, die _prinzipiell_ mit dieser Quelle bearbeitbar wären (noch ohne Eingrenzung). Beispiele für Fragetypen:
...
### Aufgabe 2b: Dieselbe Forschungsheuristik mittels KI
...
### Aufgabe 4: Externe Kritik mittels KI
...
**Ergebnis:** 1 Absatz (6–10 Sätze), der _Funktion_ und _Adressierung_ argumentiert (mit Textbelegen).
...
- Welche Interessen und Zwänge hat der Autor als Departementschef?
...
### Aufgabe 5: Interne Kritik mittels KI
...
Formulieren Sie zwei Gegenfragen, die die Notiz _herausfordern_:
...
### Aufgabe 3: Recherche- und Gegenprobe-Planung mittels KI
...
- Fokus ausschliesslich auf Prüfschritte und Gegenproben.
```
...
**B. Nicht gestützt / offen (Veto)** Aussagen, die die Notiz _nahelegt_, aber nicht belegt – oder sogar ausschliesst.
...
- „Neutralität fungiert 1949 als institutioneller Gatekeeper-Begriff, der eine Annäherung an den Europarat politisch blockiert.“
...
### Aufgabe 3: Evidenzprofil mittels KI
...
Das Analyseprotokoll dokumentiert die **Quelle**, nicht Ihre KI-Nutzung. Ihre KI-Nutzung halten Sie getrennt davon im KI-Protokoll fest.
...
### Aufgabe 2: KI-Protokoll (mindestens 6 Einträge)
...
Eine gute Quellenkritik ist nicht die, die „alles erklärt“, sondern die, die **Grenzen und Prüfschritte** sichtbar macht: Was ist belegt? Was ist hypothetisch? Was müsste als Nächstes geprüft werden?
:::
...
- ein **KI-Protokoll** mit mindestens 6 Einträgen,
...
- @stark2023conjectural – Liest maschinelles Lernen als konjekturale Wissenschaft, die aus Spuren schliesst; diskutiert die epistemologischen Risiken automatisierter Mustererkennung.
- @lang2026beyond – Ethische Datenarbeit in den (digitalen) Geisteswissenschaften; relevant für Datenprovenienz und Datensatzdokumentation.
