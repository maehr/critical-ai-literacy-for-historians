...
**Output:** eine kleine Tabelle + 5–8 Zeilen „Editionsnotizen“ (Was liefert die Edition? Was bleibt offen?).
...
**Output:** 1 Absatz (6–10 Sätze), der *Funktion* und *Adressierung* argumentiert (mit Textbelegen).
...
- Welche Outputs waren hilfreich (und warum)?
