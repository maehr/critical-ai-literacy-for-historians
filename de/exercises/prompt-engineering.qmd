...
Zero-shot als **Baseline** einsetzen: schnell, aber fehleranfällig. Sie lernen, _wo_ Zero-shot reicht und _wo_ er systematisch ausweicht.
...
Beim [Abruf aus eigenen Dokumenten](../glossary.qmd#gl-eigene-dokumente) hinterlegen Sie eine Sammlung von Dateien. Ein Suchschritt wählt daraus Abschnitte aus und legt sie dem System vor. [@lewis2020retrieval]
...
- **Offen** beschreibt die Lizenz. Bei einem [offenen Modell](../glossary.qmd#gl-offenes-modell) sind die Gewichte frei herunterladbar.
- **Lokal** beschreibt den Ort der Ausführung. Ein [lokales Modell](../glossary.qmd#gl-lokales-modell) läuft auf Ihrem eigenen Rechner.
...
- **Reproduzierbarkeit:** Nur wenn die Gewichte offen sind, behalten Sie eine feste Version. Ein geschlossenes Modell kann sich ohne Ankündigung ändern oder verschwinden. [@spirling2023open]
- **Energie:** Nur wenn das Modell klein und die Aufgabe eng ist, sinkt der Energiebedarf pro Anfrage deutlich. [@luccioni2024power]
...
- [Prompt Engineering Guide](https://www.promptingguide.ai) – Herstellerneutrale Übersicht über Prompting und seine Grundbegriffe.
- [Prompt Engineering Guide: Techniken](https://www.promptingguide.ai/techniques) – Zero-Shot, Few-Shot und Chain-of-Thought, jeweils mit Beispielen.
- [Prompt Engineering Guide: Risiken und Fehlanwendungen](https://www.promptingguide.ai/risks) – Prompt Injection, erfundene Fakten und Verzerrungen.
- [Learn Prompting](https://learnprompting.org/docs/introduction) – Offener Kurs zu Prompting, von den Grundlagen bis zu fortgeschrittenen Techniken.
- [Wikipedia: Prompt Engineering](https://de.wikipedia.org/wiki/Prompt_Engineering) – Enzyklopädischer Überblick mit Belegen zur Forschungsliteratur.
