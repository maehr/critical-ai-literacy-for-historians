...
Für diese Übung genügen folgende Arbeitsdefinitionen:

- **Prompt:** Ihre Arbeitsanweisung an das KI-System, inklusive Material, Ziel, Grenzen und gewünschtem Antwortformat.
- **KI-Protokoll / Prompt-Protokoll (Audit Trail):** Eine kurze Dokumentation von Prompts, Antworten, Prüfschritten, Korrekturen und Entscheidungen. Es funktioniert ähnlich wie ein Forschungsjournal: Der Weg zum Ergebnis bleibt nachvollziehbar.
- **Quellen-Veto:** Eine KI-Aussage wird verworfen, wenn sie nicht durch das bereitgestellte oder nachprüfbare Material gedeckt ist.
- **Claim-by-claim-Prüfung:** Jede einzelne Behauptung wird separat geprüft und entweder belegt, markiert oder gestrichen.
- **Zero-shot / Few-shot:** Beim Zero-shot erhält das Modell keine Beispiele; beim Few-shot erhält es wenige Beispiele, um Format und Qualitätsmassstab zu stabilisieren.
- **Strukturierte Denkspur / Chain-of-Thought:** Das Modell soll Zwischenschritte sichtbar machen. Diese Zwischenschritte sind keine Belege, sondern Prüfhilfen.
- **Halluzination:** Eine plausibel klingende, aber falsche oder nicht belegte KI-Ausgabe.
- **Bias:** Eine Verzerrung in Quellen, Daten, Modellen, Suchsystemen oder Interpretationen.
...
Führen Sie ein kurzes **KI-Protokoll** bzw. **Prompt-Protokoll** (Audit Trail). Nutzen Sie es auch in den anderen Übungen.
...
2. **Critique:** Nutzen Sie den kritischen Abgleich aus der Übung _Forschungsfrage_ («Warum fehlt X?» / «Auf welche Quellen stützt sich das?»).\
...
Aufgabe: Prüfe Behauptung für Behauptung:
...
Nehmen Sie die Übung _Zitieren_ und erzwingen Sie eine zweistufige Ausgabe:
