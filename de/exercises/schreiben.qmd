---
lang: de
title: Schreiben mit kritisch-reflektiertem KI-Einsatz
...
* Basiskenntnisse im Umgang mit generativer KI (Prompting)

## Lernziele

* KI-Ausgaben als Hypothesen/Entwürfe behandeln und systematisch prüfen.
...
In dieser Übung wird KI als **heuristisches Schreibwerkzeug** verstanden: Sie unterstützt bei *Formulierungen, Strukturierung und Prüfung*, ersetzt aber weder **Quellenarbeit** noch **interpretative Entscheidungen**. Methodisch hilfreich ist eine klare Arbeitsteilung:
...
* **Prüfverfahren (obligatorisch):** Jede KI-Aussage muss entweder (a) auf Ihr Input-Material rückführbar oder (b) als Hypothese gekennzeichnet und extern verifiziert sein.

Für verlässlicheres Arbeiten nutzen Sie konsequent zwei Prompt-Prinzipien: 1. **Eingrenzung des Arbeitsraums** («arbeite nur mit meinen Stichpunkten; markiere Unsicherheiten»). 2. **Formatierte Outputs** (Listen/Argumentmaps), damit Sie systematisch prüfen und selektiv übernehmen können.
...
## Arbeitsmodus: KI-Protokoll (Audit Trail)
...
**Minimalvorlage** \| Feld \| Inhalt \| \|---\|---\| \| Rolle / Übung \| \| \| Ziel (1 Satz) \| \| \| Input (welches Material?) \| \| \| Prompt (Kernausschnitt) \| \| \| Output (kurz) \| \| \| Prüfschritte (wie verifiziert?) \| \| \| Entscheidung (übernommen/angepasst/verworfen + Begründung) \| \|
:::
...
**Output** - 1 revidierter Auftrag (3–5 Sätze) + 3 definierte Kernbegriffe
...
**Output** - 1 priorisierte Hypothese/These + 2 zentrale Gegenargumente + 1 geplanter Stress-Test
...
**Output** - Gliederung + Markierung von 2–3 Evidenzlücken
...
**Output** - 1 Absatz + eine Version, in der Sie 3–5 Sätze eigenständig präzisiert haben
...
**Output** - 1 überarbeiteter Übergang/Definition + kurze Begründung, warum diese Variante
...
**Output** - Argumentmap + 2 gezielte Revisionen im Text (mit Markierung, was sich logisch verbessert)
...
**Output** - Korrigierte Version + (optional) Übersetzung + Glossar
...
**Output** - Abstract + 2-Satz-Meta-Kommentar: Was hat KI fälschlich betont/ausgelassen?
...
**Output** - 3 präzisierte Stellen im Text (je 1–2 Sätze überarbeitet)
