---
lang: de
title: "Kritisch-reflektierter KI-Einsatz in Public History"
...
* KI-Ausgaben systematisch prüfen (Claim-by-claim, Quellen-Veto, Unsicherheiten markieren) und Änderungen nachvollziehbar dokumentieren (Audit Trail).
...
5. **KI-Protokoll** (Prompt-/Output-Log + Reflexionsnotiz, ca. 300–500 Wörter)

## Methodischer Rahmen: KI als kritisch-reflektierte Vermittlungsinfrastruktur

Begriffe (für diese Übung):

* **Audit Trail (KI-Protokoll):** Dokumentation von Prompts, Outputs, Entscheidungen, Korrekturen und Quellenstellen, sodass Ihr Prozess nachvollziehbar bleibt.
