...
- Antworten systematisch prüfen (Behauptung für Behauptung, Quellen-Veto, Unsicherheiten markieren) und Änderungen nachvollziehbar in einem KI-Protokoll dokumentieren.
...
- **KI-Protokoll (Audit Trail):** Dokumentation von Prompts, Antworten, Entscheidungen, Korrekturen und Quellenstellen, sodass Ihr Arbeitsweg nachvollziehbar bleibt.
- **Quellen-Veto:** Eine KI-Aussage oder narrative Zuspitzung wird verworfen, wenn sie den belegten Aussagen im Artikel widerspricht oder nicht durch das Material gedeckt ist.
- **Prüfung Behauptung für Behauptung (Claim-by-claim Check):** Aussagen werden in überprüfbare _Behauptungen_ zerlegt, mit Belegstellen verknüpft oder als Spekulation markiert.
...
- **Behauptung für Behauptung prüfen**: Jede Aussage entweder belegen, als Einordnung markieren oder streichen.
...
Erstellen Sie ein Interview-Kit (1–2 Seiten): - **3 Soundbites** (je 12–20 Sekunden, sinngemäss) - **5 Kernfragen** + kurze Antworten (je 3–5 Sätze) - **2 kritische Fragen** (z.B. «Ist das nicht…?») + Brückenstrategien - **No-go-Liste**: Aussagen, die Sie _nicht_ machen (wegen Evidenz/Komplexität/Ethik) - **Transparenzsatz** zu Methode und Datenlage (1–2 Sätze)
