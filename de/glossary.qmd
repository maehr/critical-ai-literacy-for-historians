...
Im Denkmodus erzeugt das KI-System von sich aus Zwischenschritte, bevor es antwortet. Sie haben diesen Ablauf nicht vorgegeben, anders als bei der strukturierten Denkspur.

### Agentischer Ablauf (Agentic Workflow) {#gl-agentischer-ablauf}

In einem agentischen Ablauf plant das KI-System mehrere Schritte, ruft dafür Werkzeuge auf und arbeitet ohne Rückfrage weiter.

### Vertiefte Recherche (Deep Research) {#gl-vertiefte-recherche}

Bei einer vertieften Recherche sucht das KI-System selbständig im Web, liest Seiten und liefert einen Bericht mit Belegstellen. Der Bericht ist eine Trefferliste mit Hypothesen und keine geprüfte Literaturübersicht.

### Abruf aus eigenen Dokumenten (Retrieval-Augmented Generation, RAG) {#gl-eigene-dokumente}

Beim Abruf aus eigenen Dokumenten hinterlegen Sie eine Sammlung von Dateien. Ein Suchschritt wählt daraus Abschnitte aus, und das KI-System antwortet auf dieser Grundlage.

### Multimodales Lesen (Multimodal) {#gl-multimodal}

Multimodal heisst, dass ein KI-System nicht nur Text verarbeitet, sondern auch Bilder, Tonaufnahmen oder Videos. Ein Digitalisat einer Akte ist für das System ein Bild.

### Offenes Modell und lokales Modell (Open-Weight Model) {#gl-offenes-modell}

Bei einem offenen Modell sind die Gewichte frei herunterladbar. Ein lokales Modell läuft auf Ihrem eigenen Rechner, und Ihr Material verlässt diesen Rechner nicht.
...
Die Handschriftenerkennung wandelt eine handschriftliche Seite in Text um. Die Fehlerrate hängt stark von Schrift, Layout, Sprache und Zustand der Vorlage ab, und das Ergebnis bleibt eine Lesehypothese.
...
Die drei folgenden Einträge geben eine Orientierung und keine Rechtsberatung. Verbindlich sind der Gesetzestext und die Vorgaben Ihrer Institution.
...
In der EU regelt die Datenschutz-Grundverordnung die Verarbeitung personenbezogener Daten, in der Schweiz das revidierte Datenschutzgesetz [@eu2016dsgvo; @schweiz2020datenschutzgesetz]. Für die Forschung gelten Erleichterungen, aber keine Freistellung [@edpb2026forschung].

### KI-Verordnung (EU AI Act) {#gl-kiverordnung}

Die KI-Verordnung der EU regelt das Inverkehrbringen und den Einsatz von KI-Systemen [@eu2024kiverordnung]. Für Sie zählt vor allem Artikel 50: Er verlangt seit dem 2. August 2026 eine Kennzeichnung von erzeugten Bildern, Tonaufnahmen und Videos sowie von erzeugten Texten zu Fragen von öffentlichem Interesse.
