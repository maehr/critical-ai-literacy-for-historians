...
- **Nachhaltigkeit** durch [Minimal Computing](glossary.qmd#gl-minimal-computing), also durch Verfahren mit geringem Rechenaufwand. Der konkrete Weg dazu ist das [lokale oder offene Modell](glossary.qmd#gl-offenes-modell). Es braucht pro Anfrage deutlich weniger Energie als ein grosses Allzweckmodell [@luccioni2024power], es hält eine feste Version fest [@spirling2023open] und es lässt Ihr Material auf Ihrem Rechner. Der Abschnitt [Fähigkeiten prüfen und einordnen](exercises/prompt-engineering.qmd#sec-faehigkeiten) zeigt, wann sich dieser Weg lohnt.
