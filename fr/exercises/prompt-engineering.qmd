...
2) **Critiquer:** Utilisez la comparaison critique de l'exercice *Question de recherche* (« Pourquoi X manque-t-il ? » / « Sur quelles sources cela repose-t-il ? »).\
...
- [Prompt Engineering Guide](https://www.promptingguide.ai) (ANGLAIS) – Vue d'ensemble neutre du prompting et de ses notions de base.
- [Prompt Engineering Guide: Techniques](https://www.promptingguide.ai/techniques) (ANGLAIS) – Zero-shot, few-shot et chain-of-thought, avec des exemples.
- [Prompt Engineering Guide: Risks and misuses](https://www.promptingguide.ai/risks) (ANGLAIS) – Injection de prompt, faits inventés et biais.
- [Learn Prompting](https://learnprompting.org/docs/introduction) (ANGLAIS) – Cours ouvert sur le prompting, des bases aux techniques avancées.
- [Wikipedia : Ingénierie de prompt](https://fr.wikipedia.org/wiki/Ing%C3%A9nierie_de_prompt) – Vue d'ensemble encyclopédique avec des références à la littérature de recherche.
- [Playlist YouTube : Littératie critique de l'IA (Zentralbibliothek Zürich)](https://www.youtube.com/playlist?list=PLxDekeBVQtVJoizqbYM0ghqolcN3jUPsy) – Série de vidéos sur l'apprentissage automatique, les modèles de langage, le prompting, les biais, la visualisation de données, les méthodes d'évaluation et la science ouverte. (GERMAN only)
- @sternfeld2023historian – Explique comment un système d'apprentissage automatique « apprend » à partir d'un jeu de données et pourquoi l'IA fonctionne comme un système sociotechnique et non comme un agent autonome.
