...
## Mode de travail: Protocole IA

Pendant l'exercice, maintenez un bref **protocole IA**: une trace vérifiable de vos prompts, réponses, étapes de vérification et décisions (aussi appelée piste d'audit). Cela fait partie de la traçabilité scientifique et facilite la divulgation ultérieure dans la section méthodes.
